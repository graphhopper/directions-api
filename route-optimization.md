...
time_windows | array | - | - | Specifies an array of time window objects (see time window object below). For example, if an item needs to be delivered between 7am and 9am then specify the array as follows: `[ { "earliest": 25200, "latest" : 32400 } ]` (starting the day from 0 in seconds, e.g. for 7am it is `7*60*60=25200`). If the delivery facility has a lunch break and is just open from 9am to 12am and 2pm to 6pm, just define the time windows as follows: `[ { "earliest": 32400, "latest" : 43200 },` `{ "earliest": 50400, "latest" : 64800 } ]`. If you need a time for the next day you add 24 hours, e.g. 7am on the second day is `60*60*(7+24)=111600`.
