...
capacity | array | - | [ 0 ] | Specifies an array of capacity dimension values. If there are two dimensions such as volume and weight then it needs to be defined as `[ 1000, 300 ]` assuming a maximum volume of 1000 and a maximum weight of 300.
